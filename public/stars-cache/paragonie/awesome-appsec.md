...
### ⭐️ 1,273 [Hack Night](https://github.com/isislab/Hack-Night)
...
### ⭐️ 2,061 [OWASP NodeGoat](https://github.com/owasp/nodegoat)

Purposly vulnerable to the OWASP Top 10 Node.JS web application, with [tutorials](https://nodegoat.herokuapp.com/tutorial), ⭐️ 2,061 [security regression testing with the OWASP Zap API](https://github.com/OWASP/NodeGoat), [docker image](https://github.com/owasp/nodegoat#option-3---run-nodegoat-on-docker). With several options to get up and running fast.
...
### ⭐️ 41 [Clojure OWASP](https://github.com/nubank/clj-owasp) (2020)
...
### ⭐️ 679 [Awesome Electron.js hacking & pentesting resources](https://github.com/doyensec/awesome-electronjs-hacking) (2020)
...
Discusses the importance of end-to-end network-layer encryption (HTTPS) as well as secure encryption for data at rest, then introduces the specific cryptography tools that developers should use for specific use cases, whether they use [libsodium](https://pecl.php.net/package/libsodium), ⭐️ 3,866 [Defuse Security's secure PHP encryption library](https://github.com/defuse/php-encryption), or OpenSSL.
...
### ⭐️ 3,866 [defuse/php-encryption](https://github.com/defuse/php-encryption)

Symmetric-key encryption library for PHP applications. (**Recommended** over rolling your own!)

### ⭐️ 2,129 [ircmaxell/password_compat](https://github.com/ircmaxell/password_compat)

If you're using PHP 5.3.7+ or 5.4, use this to hash passwords

### ⭐️ 840 [ircmaxell/RandomLib](https://github.com/ircmaxell/RandomLib)

Useful for generating random strings or numbers

### ⭐️ 6,661 [thephpleague/oauth2-server](https://github.com/thephpleague/oauth2-server)

A secure OAuth2 server implementation

### ⭐️ 8,155 [paragonie/random_compat](https://github.com/paragonie/random_compat)
...
### ⭐️ 361 [psecio/gatekeeper](https://github.com/psecio/gatekeeper)
...
### ⭐️ 410 [OWASP Python Security Wiki](https://github.com/ebranca/owasp-pysec) (2014)
...
A guide to secure Ruby development by the Fedora Security Team. Also available on ⭐️ 10 [Github](https://github.com/jrusnack/secure-ruby-development-guide).
