...
⭐️ 2,471 [![Docs](https://github.com/j-hui/fidget.nvim)](doc/fidget.txt)
...
!⭐️ 2,471 [fidget.nvim demo](https://github.com/j-hui/fidget.nvim)
...
- Terminal + font: [Kitty](https://sw.kovidgoyal.net/kitty/) + ⭐️ 1,257 [Comic Shanns Mono](https://github.com/shannpersand/comic-shanns)
- Editor: ⭐️ 96,356 [Neovim v0.9.4](https://github.com/neovim/neovim)
- Theme: ⭐️ 7,185 [catppuccin/nvim (mocha, dark)](https://github.com/catppuccin/nvim)
- Status line: ⭐️ 7,729 [nvim-lualine/lualine.nvim](https://github.com/nvim-lualine/lualine.nvim)
- Color columns: `:set colorcolumn=81,121,+1,+2` (sorry)
- Scrollbar: ⭐️ 1,025 [petertriho/nvim-scrollbar](https://github.com/petertriho/nvim-scrollbar)
...
⭐️ 2,471 [this Wiki page](https://github.com/j-hui/fidget.nvim).
...
#### ⭐️ 20,208 [Lazy](https://github.com/folke/lazy.nvim)
...
#### ⭐️ 35,545 [vim-plug](https://github.com/junegunn/vim-plug)
...
#### ⭐️ 1,003 [rocks.nvim](https://github.com/nvim-neorocks/rocks.nvim)
...
one of the ⭐️ 2,471 [release tags](https://github.com/j-hui/fidget.nvim).

For instance, using ⭐️ 20,208 [Lazy](https://github.com/folke/lazy.nvim):
...
⭐️ 3,521 [rcarriga/nvim-notify](https://github.com/rcarriga/nvim-notify) is first and
foremost a `vim.notify()` backend, and it also supports
⭐️ 3,521 [LSP progress notifications](https://github.com/rcarriga/nvim-notify)
(with the integration seems to have been packaged up in
⭐️ 55 [mrded/nvim-lsp-notify](https://github.com/mrded/nvim-lsp-notify)).

⭐️ 198 [vigoux/notifier.nvim](https://github.com/vigoux/notifier.nvim) is
a `vim.notify()` backend that comes with first-class LSP notification support.

⭐️ 25,134 [neoclide/coc.nvim](https://github.com/neoclide/coc.nvim) provides a nice LSP
progress UI in the status line, which first inspired my desire to have this
feature for nvim-lsp.

⭐️ 246 [arkav/lualine-lsp-progress](https://github.com/arkav/lualine-lsp-progress) was
the original inspiration for Fidget, and funnels LSP progress messages into
⭐️ 7,729 [nvim-lualine/lualine.nvim](https://github.com/nvim-lualine/lualine.nvim).
I once borrowed some of its code (though much of that code has since been
rewritten).

⭐️ 658 [nvim-lua/lsp-status.nvim](https://github.com/nvim-lua/lsp-status.nvim) also
...
⭐️ 2,752 [sindresorhus/cli-spinners](https://github.com/sindresorhus/cli-spinners).
