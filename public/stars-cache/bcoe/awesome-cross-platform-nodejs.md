...
- ⭐️ 1,413 [Cross-platform Node.js guide](https://github.com/ehmicky/cross-platform-node-guide) - How to write cross-platform Node.js code.
- ⭐️ 2,503 [Microsoft Node.js Guidelines](https://github.com/Microsoft/nodejs-guidelines) - Tips, tricks, and resources for working with Node.js on Microsoft platforms.
...
- ⭐️ 244 [Cross-platform terminal characters](https://github.com/ehmicky/cross-platform-terminal-characters) - All the characters that work on most terminals and most operating systems.
...
- ⭐️ 44,888 [nvm-windows](https://github.com/coreybutler/nvm-windows) - Manage multiple installations of Node.js on a Windows computer.
- ⭐️ 91,615 [nvm](https://github.com/creationix/nvm) / [n](https://github.com/tj/n) - Node version manager for macOS/Linux.
- ⭐️ 2,516 [npm-windows-upgrade](https://github.com/felixrieseberg/npm-windows-upgrade) - Upgrade npm on Windows.
- ⭐️ 3,417 [windows-build-tools](https://github.com/felixrieseberg/windows-build-tools) - Install C++ Build Tools for Windows using npm.
...
- ⭐️ 9,978 [Redis](https://github.com/tporadowski/redis) - Native port of Redis for Windows.

## Libraries

### OS identification

- ⭐️ 48 [is-windows](https://github.com/jonschlinkert/is-windows) - Detect whether the current platform is Windows.
- ⭐️ 199 [is-wsl](https://github.com/sindresorhus/is-wsl) - Detect whether current platform is WSL (Windows Subsystem for Linux).
- ⭐️ 79 [getos](https://github.com/retrohacker/getos) - Retrieve the current OS, including Linux distribution.
- ⭐️ 148 [os-name](https://github.com/sindresorhus/os-name) - Get the name of the current operating system.
- ⭐️ 3,059 [systeminformation](https://github.com/sebhildebrandt/systeminformation) - Hardware/software system information.

### Shell

- ⭐️ 7,429 [execa](https://github.com/sindresorhus/execa) - Cross-platform implementation of `child_process.{execFile,exec}`.
- ⭐️ 57 [gulp-execa](https://github.com/ehmicky/gulp-execa) - Cross-platform command execution in Gulp.js.
- ⭐️ 1,167 [cross-spawn](https://github.com/IndigoUnited/node-cross-spawn) - Cross-platform implementation of `child_process.spawn()`.
- ⭐️ 14,407 [shelljs](https://github.com/shelljs/shelljs) - Cross-platform Unix shell commands.
- ⭐️ 2,926 [node-windows](https://github.com/coreybutler/node-windows) - Windows support for Node.js scripts (daemons, eventlog, UAC, etc).
- ⭐️ 769 [log-symbols](https://github.com/sindresorhus/log-symbols) - Colored symbols for various log levels with Windows fallbacks.
- ⭐️ 620 [figures](https://github.com/sindresorhus/figures) - Unicode symbols with Windows fallbacks.
- ⭐️ 1,939 [clipboardy](https://github.com/sindresorhus/clipboardy) / [clipboard-cli](https://github.com/sindresorhus/clipboard-cli) - Cross-platform copy/paste.

### Environment

- ⭐️ 6,532 [cross-env](https://github.com/kentcdodds/cross-env) - Set environment variables cross-platform.
- ⭐️ 159 [user-home](https://github.com/sindresorhus/user-home) - Get the path to the user home directory. Cross-platform.
- ⭐️ 145 [username](https://github.com/sindresorhus/username) - Get the current username.
- ⭐️ 137 [osenv](https://github.com/npm/osenv) - Cross-platform environment variables.
- ⭐️ 43 [is-elevated](https://github.com/sindresorhus/is-elevated) - Check if the process is running with elevated privileges.
- ⭐️ 349 [which](https://github.com/npm/node-which) - Cross-platform implementation of Unix's `which`.

### Filesystem

- ⭐️ 5,834 [rimraf](https://github.com/isaacs/rimraf) / [del](https://github.com/sindresorhus/del) - Delete files and folders. Cross-platform.
- ⭐️ 477 [make-dir](https://github.com/sindresorhus/make-dir) - Cross-platform `mkdir -p`.
- ⭐️ 417 [readdirp](https://github.com/paulmillr/readdirp) - Recursive version of `fs.readdir()`.
- ⭐️ 435 [cpy](https://github.com/sindresorhus/cpy) - Copy files. Cross-platform.
- ⭐️ 11,916 [chokidar](https://github.com/paulmillr/chokidar) - Improved cross-platform file watching.
- ⭐️ 1,304 [graceful-fs](https://github.com/isaacs/node-graceful-fs) - Improves the `fs` module, especially on Windows.
- ⭐️ 9,617 [fs-extra](https://github.com/jprichardson/node-fs-extra) - Combines `graceful-fs` with better JSON file reading and promises.
- ⭐️ 4 [any-path](https://github.com/bcoe/any-path) - Use Windows and POSIX paths interchangeably when fetching values from an object.
- ⭐️ 94 [dev-null-cli](https://github.com/sindresorhus/dev-null-cli) - Cross-platform `/dev/null`.
- ⭐️ 6 [global-cache-dir](https://github.com/ehmicky/global-cache-dir) - Get the global OS-specific cache directory.

### Signals

- ⭐️ 789 [fkill](https://github.com/sindresorhus/fkill) - Kill processes. Cross-platform.
- ⭐️ 197 [signal-exit](https://github.com/tapjs/signal-exit) - Cross-platform `exit` handler.
- ⭐️ 287 [human-signals](https://github.com/ehmicky/human-signals) - Human-friendly process signals.

### Processes

- ⭐️ 283 [ps-list](https://github.com/sindresorhus/ps-list) - Get running processes.
- ⭐️ 61 [process-exists](https://github.com/sindresorhus/process-exists) - Check if a process exists.

### Streams

- ⭐️ 53 [noop-stream](https://github.com/sindresorhus/noop-stream) - Cross-platform `fs.createReadStream('/dev/null')`.
- ⭐️ 78 [random-bytes-readable-stream](https://github.com/sindresorhus/random-bytes-readable-stream) - Cross-platform `fs.createReadStream('/dev/urandom')`.

### Desktop UI

- ⭐️ 3,444 [open](https://github.com/sindresorhus/open) - Opens stuff like websites, files, executables. Cross-platform.
- ⭐️ 5,833 [node-notifier](https://github.com/mikaelbr/node-notifier) - Cross-platform desktop notifications.

### Windows registry

- ⭐️ 218 [node-winreg](https://github.com/fresc81/node-winreg) - Access the Windows registry.
- ⭐️ 55 [rage-edit](https://github.com/MikeKovarik/rage-edit) - Access/modify the Windows registry.
- ⭐️ 118 [windows-registry-node](https://github.com/CatalystCode/windows-registry-node) - Access/modify the Windows registry and set file associations.

## Known issues

- ⭐️ 34,353 [cmd.exe unicode woes](https://github.com/nodejs/node-v0.x-archive) - By default, `cmd.exe` does not display Unicode characters on Windows.
- ⭐️ 34,353 [spawn issues](https://github.com/nodejs/node-v0.x-archive) - `child_process.spawn()` behavior is not consistent between Windows and Linux.
- ⭐️ 38 [exec() behavior between shells](https://github.com/isaacs/spawn-wrap) - Depending on the shell being used, e.g., bash vs. dash, `child_process.exec()` has inconsistent exit behavior.

## See also

- ⭐️ 860 [awesome-desktop-js](https://github.com/styfle/awesome-desktop-js) - List of tools to build JavaScript applications on the desktop.
...
This project follows the ⭐️ 8,005 [all-contributors](https://github.com/all-contributors/all-contributors) specification.
